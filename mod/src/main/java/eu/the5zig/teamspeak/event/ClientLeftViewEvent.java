...
public class ClientLeftViewEvent extends Event
{
    ...
    protected ClientLeftViewEvent(final ServerTab tab, final Client client, final Channel from, final Channel to, final Reason reason, final String reasonMessage) {
        super(tab);
        this.client = client;
        this.from = from;
        this.to = to;
